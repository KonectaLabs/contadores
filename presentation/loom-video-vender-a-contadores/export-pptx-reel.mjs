...
const W = 1080;
const H = 1920;
const htmlPath = join(__dirname, 'deck-export-reel.html');
const outPptx = join(__dirname, 'Konecta-Reel-Vender-a-Contadores.pptx');
const tmpDir = join(__dirname, '.pptx-build-reel');
...
pptx.defineLayout({ name: 'REEL_9_16', width: 7.5, height: 13.333 });
pptx.layout = 'REEL_9_16';
pptx.author = 'Konecta Labs';
pptx.title = 'Reel — Vender a contadores';
