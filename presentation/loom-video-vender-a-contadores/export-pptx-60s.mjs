...
const W = 1920;
const H = 1080;
const htmlPath = join(__dirname, 'deck-export-60s.html');
const outPptx = join(__dirname, 'Konecta-Loom-Vender-a-Contadores-60s.pptx');
const tmpDir = join(__dirname, '.pptx-build-60s');
...
pptx.title = 'Loom 60s — Vender a contadores';
